...
****************************************************/
  ...
  * BUSY   ->    18 (Physical, BCM: 24)
  ...
  == How to use ==
  1, install the C libraries of bcm2835 or wiringpi.Change the library you choose to use in the Makefile file
  2, change the current directory to where the Makefile and demo files located.
  3, compile the file with: make
  4, run the demo with: sudo ./epd
  */
